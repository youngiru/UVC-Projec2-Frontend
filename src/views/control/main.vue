<template>
  <div id="control_main_wrap">
    <div class="control_main_box">
      <b-container class="bv-example-row control_main_box_co">
        <b-row>
          ...
          <b-col class="control_main_text" @click="$router.push('/control/completionhistory')">완료이력</b-col>
